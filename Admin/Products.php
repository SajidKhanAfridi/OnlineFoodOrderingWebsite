...
mysql_select_db($database_cafeteria, $cafeteria);
$query_Recordset2 = sprintf("SELECT ItemId, ItemName,Image, Price, Total FROM item_master WHERE CategoryId = %s", GetSQLValueString($colname_Recordset2, "int"));
