...
$sql = "SELECT food_cart.CartId, food_cart.ItemName, food_cart.Quantity, food_cart.Total,item_master.Image
FROM admin_master, food_cart, item_master
WHERE item_master.ItemName=food_cart.ItemName and food_cart.CustomerId=".$_SESSION['ID']."";
// Execute query
